 ...
 *  — the Encryption screen carries both in every build now, decision 14. **Change key scope** went
 *  the same way at U5: the library long-press sheet's two key rows are that code in every build.)
