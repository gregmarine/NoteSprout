...
- **This and following** — `deleteWithScope` truncates the series to `UNTIL occurrence − 1`
  ...
  changed rule, but a rule the person retyped is theirs, count included (arc 34 / M3). A
