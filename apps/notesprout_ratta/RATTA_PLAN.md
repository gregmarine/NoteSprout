...
`0.1.0-ratta`; **2087 JVM tests/variant**. **Arc 25 "Drive" (the EIGHTH point, `ACTION_CLOUD_STORAGE`, granted 2026-09-04; V1–V6 complete + frozen 2026-09-05 — `:ext-cloud`, THIRTEEN modules, `API_VERSION` 8, 2340 JVM tests/variant, reference `docs/cloud.md`) lives in its OWN file — `DRIVE_PLAN.md`; read that, not this, for arc-25 work.** **Arc 26 "Keys" (og-parity encryption, `PARITY_BACKLOG.md` item 1; U1–U7 complete + frozen 2026-09-05 — host-only, no point, no API bump, 1077 `:app` tests, reference `docs/encryption.md`) lives in its OWN file — `ENCRYPTION_PLAN.md`; read that, not this, for arc-26 work. Arcs 1–26 are all frozen.** **Arc 27 "Restore" (whole-library restore, `PARITY_BACKLOG.md` item 2; L1–L6 complete + frozen 2026-09-06 — host-only, no point, no API bump, 1194 `:app` tests, reference `docs/restore.md`) lives in its OWN file — `RESTORE_PLAN.md`; read that, not this, for arc-27 work. Arcs 1–27 are all frozen. **Arc 28 "Objects" (sticky notes, text objects, six hand-placed shapes — `PARITY_BACKLOG.md` item 3; wizard locked 2026-09-06, H1 ⬜ next) lives in its OWN file — `OBJECTS_PLAN.md`; read that, not this, for arc-28 work.** No other arc and no NINTH extension point without another user decision.**
