 ...
 * by the deeper list, never the shallow one. Runs against [FakeSoilDao], which mirrors the `@Query`
 * strings by hand — the point of the suite is to keep the fake and the SQL from drifting apart.
 */
